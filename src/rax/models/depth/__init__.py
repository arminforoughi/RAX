...
from rax.models.depth.stereo import ROI, StereoDepth, StereoIntrinsics
...
def make_stereo(
    ...
    *,
    ...
    if want in ("auto", "raft"):
        from rax.models.depth.raft_stereo import RaftStereo
    ...
    if want in ("auto", "foundation"):
        from rax.models.depth.foundation_stereo import FoundationStereoBackend
