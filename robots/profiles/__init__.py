...
from robots.profiles.urdf_limits import joint_limits_deg, read_urdf_limits

__all__ = [
    "ArmProfile", "GripperProfile", "CameraProfile", "BusProfile",
...
_PROFILES = {
    "so101": ("robots.profiles.so101", "PROFILE"),
    "mock": ("robots.profiles.mock", "PROFILE"),
}
